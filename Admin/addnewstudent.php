...
if (isset($_REQUEST['newStuSubmitBtn'])) {
  ...
  if (($_REQUEST['stu_name'] == "") || ($_REQUEST['stu_email'] == "") || ($_REQUEST['stu_pass'] == "") || ($_REQUEST['stu_occ'] == "")) {
    ...
    if($conn->query($sql) == TRUE){
      ...
      $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Student details Added Successfully </div>';
     } else {
      // below msg display on form submit failed
      $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Unable to Add Student details </div>';
     }
  }
}
?>
