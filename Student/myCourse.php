 ...
 <div class="container mt-5 ml-2">
  <div class="row">
   ...
   if(isset($stuLogEmail)){
    $sql = "SELECT co.order_id, c.course_id, c.course_name, c.course_duration, c.course_desc, c.course_img, c.course_author, c.course_price, c.course_org FROM courseorder AS co JOIN course AS c ON c.course_id = co.course_id WHERE co.stu_email = '$stuLogEmail'";
          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <p class="card-text d-inline">Price: <small><del>&#8377 <?php echo $row['course_price'] ?> </del></small> <span class="font-weight-bolder">&#8377 <?php echo $row['course_org']?> <span></p>
