 ...
 <div class="col-sm-6 mt-5">
  <form class="mx-5" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="text" class="form-control mt-2" id="stuId" name="stuId" value=" <?php if(isset($stuId)) {echo $stuId;} ?>" readonly>
    </div>
    <div class="form-group mt-2">
      <label for="f_content">Write Feedback:</label>
      <textarea class="form-control mt-2" id="f_content" name="f_content" row=2></textarea>
    </div>
